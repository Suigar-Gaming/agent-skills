...
- Use `suigar-nft-lookup` for application-side NFT V1 ownership and catalog lookups using SDK-resolved package ids and BCS helpers. It does not cover NFT minting.
